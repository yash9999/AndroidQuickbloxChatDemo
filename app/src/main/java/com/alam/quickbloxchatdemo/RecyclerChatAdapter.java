...
import com.alam.quickbloxchatdemo.utils.Utility;
...
//                holder.frmReceiverImage.setVisibility(View.GONE);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        @InjectView(R.id.txtMessageReceiver)
        TextView txtMessageReceiver;

        @InjectView(R.id.card_view_receiver)
        CardView card_view_receiver;

        @InjectView(R.id.card_view_Sender)
        CardView card_view_Sender;

        @InjectView(R.id.txtMessageSender)
