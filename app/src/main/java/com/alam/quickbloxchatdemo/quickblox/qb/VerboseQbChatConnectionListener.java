...
import com.alam.quickbloxchatdemo.MyApplication;
import com.alam.quickbloxchatdemo.R;
...
public class VerboseQbChatConnectionListener implements ConnectionListener {
    ...
    public void connectionClosedOnError(final Exception e) {
        ...
        snackbar = Snackbar.make(rootView, MyApplication.getInstance().getString(R.string.internet_connectivity_message), Snackbar.LENGTH_INDEFINITE);
        snackbar.show();
    }
